...
**Description: **_**Candidates should be able to determine and configure fundamental system hardware.**_
...
```
root@amirreza:/# cat /proc/cpuinfo 
processor    : 0
...
```
root@amirreza:/# cat /proc/filesystems 
nodev	sysfs
nodev	rootfs
nodev	ramfs
nodev	bdev
...
```
root@amirreza:/# cat /proc/interrupts 
            CPU0       
...
```
root@amirreza:/# cat /proc/meminfo 
MemTotal:         994868 kB
MemFree:          114032 kB
...
```
root@amirreza:/# udevadm info --query=all --name=/dev/sdb
...
### [PreviousTopic 101: System Architecture](https://app.gitbook.com/o/6QEdxf6L79OmJhExVmnL/s/nFM9yZYIAxBy5HEkObxf/\~/changes/12/topic-101-system-architecture)lsmod

lsmod is a very simple program with no options.

```
root@amirreza:/# lsmod --help
Usage: lsmod
```
...
```
root@amirreza:/# modprobe -r e1000
root@amirreza:/# modprobe e1000
```
...
[https://www.linuxtopia.org/online\_books/introduction\_to\_linux/linux\_The\_most\_common\_devices.html](https://www.linuxtopia.org/online\_books/introduction\_to\_linux/linux\_The\_most\_common\_devices.html)
...
[https://access.redhat.com/documentation/en-us/red\_hat\_enterprise\_linux/6/html/deployment\_guide/s2-sysinfo-hardware-lsusb](https://access.redhat.com/documentation/en-us/red\_hat\_enterprise\_linux/6/html/deployment\_guide/s2-sysinfo-hardware-lsusb)
